...
def cleanDownstreamRepos() {
    repos = ['git@bitbucket.org:nextiva/test-js-pipeline.git',
             'git@bitbucket.org:nextiva/test-java-pipeline.git',
             'git@bitbucket.org:nextiva/test-python-pipeline.git']
