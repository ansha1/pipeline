...
def call(body) {
    ...
    CHANNEL_TO_NOTIFY = pipelineParams.CHANNEL_TO_NOTIFY ?: DEFAULT_SLACK_CHANNEL
        ...
        post {
            success {
                script {
                    ...
                    SlackMessage slackMessage = new MessagesFactory(this).buildReleaseStartMessage(releaseVersion, user)
