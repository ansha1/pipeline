...
def privateMessage(String slackUserId, String message) {
    ...
    httpRequest contentType: 'APPLICATION_JSON', httpMode: 'PUT', requestBody: 'text=' + message, url: "https://nextivalab.slack.com/api/chat.postMessage?token=${SLACK_BOT_TOKEN}&channel=${slackUserId}&as_user=true"
