        ...
        return [
                ["feature", BranchNames.feature.toList(),
                 ["Checkout", "StartBuildDependencies", "ConfigureProjectVersion", "Build",
                  "pip: build", "UnitTest", "pip: unitTest", "IntegrationTest", "pip: integrationTest",
                  "CollectBuildResults", "SendNotifications"]],
                ["develop", BranchNames.develop.toList(),
                 ["Checkout", "StartBuildDependencies", "ConfigureProjectVersion", "Build",
                  "pip: build", "UnitTest", "pip: unitTest", "SonarScan", "IntegrationTest",
                  "pip: integrationTest", "Publish", "pip: publishArtifact", "Deploy",
                ...
                ["release", BranchNames.release.toList(),
                 ["Checkout", "StartBuildDependencies", "VerifyArtifactVersionInNexus",
                  ...
                  "Build", "pip: build", "UnitTest", "pip: unitTest", "IntegrationTest", "pip: integrationTest",
                  "Publish", "pip: publishArtifact", "SecurityScan", "Deploy", "kubeup Deploy: Deploy to qa",
                  "pip: postDeploy", "QACoreTeamTest", "QA Core Team Tests", "CollectBuildResults",
                  "SendNotifications"]],
